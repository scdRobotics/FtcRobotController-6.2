...
@TeleOp(name = "RTPLinearTeleOpUsingDist (Okonkwo)", group = "Current")

public class LinearTeleOpDistPlusRTP extends LinearOpMode {
    ...
    protected DistanceSensor backLeftDist;
    protected double readBackLeftDist;
    protected DistanceSensor backRightDist;
    protected double readBackRightDist;

    protected DistanceSensor frontLeftDist;
    protected double readFrontLeftDist;
    protected DistanceSensor frontRightDist;
    protected double readFrontRightDist;

    protected DistanceSensor leftFrontDist;
    protected double readLeftFrontDist;
    protected DistanceSensor leftBackDist;
    protected double readLeftBackDist;

    protected DistanceSensor rightFrontDist;
    protected double readRightFrontDist;
    protected DistanceSensor rightBackDist;
    protected double readRightBackDist;
    ...
    public void readFrontLeftDist(){
        readFrontLeftDist=frontLeftDist.getDistance(DistanceUnit.CM);
    }
    public void readFrontRightDist(){
        readFrontRightDist=frontRightDist.getDistance(DistanceUnit.CM);
    }
    public void readBackLeftDist(){
        readBackLeftDist=backLeftDist.getDistance(DistanceUnit.CM);
    }
    public void readBackRightDist(){
        readBackRightDist=backRightDist.getDistance(DistanceUnit.CM);
    }
    public void readLeftFrontDist(){

    }
    public void readLeftBackDist(){

    }
    public void readRightFrontDist(){

    }
    public void readRightBackDist(){
